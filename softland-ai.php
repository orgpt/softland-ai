...
final class Softland_AI_Plugin {
	...
	public function enqueue_frontend_assets() {
		...
		wp_enqueue_style(
			...
			array(),
			file_exists( $this->plugin_path( 'assets/css/frontend-v2.css' ) ) ? filemtime( $this->plugin_path( 'assets/css/frontend-v2.css' ) ) : '1.1.4'
		);
		...
		wp_enqueue_script(
			...
			array(),
			file_exists( $this->plugin_path( 'assets/js/frontend.js' ) ) ? filemtime( $this->plugin_path( 'assets/js/frontend.js' ) ) : '1.1.4',
			true
		);
			...
			<section class="softland-ai__panel" id="softland-ai-panel" data-softland-ai-panel hidden aria-hidden="true">
				<div class="softland-ai__card">
					...
					<form class="softland-ai__composer" data-softland-ai-form>
						...
						<button class="softland-ai__submit" type="submit" data-softland-ai-submit aria-label="<?php echo esc_attr( 'إرسال' ); ?>">ارسال→</button>
					</form>
