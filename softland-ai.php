...
final class Softland_AI_Plugin {
	...
	public function enqueue_frontend_assets() {
		...
		wp_enqueue_style(
			...
			array(),
			file_exists( $this->plugin_path( 'assets/css/frontend-v2.css' ) ) ? filemtime( $this->plugin_path( 'assets/css/frontend-v2.css' ) ) : '1.1.9'
		);
		...
		wp_enqueue_script(
			...
			array(),
			file_exists( $this->plugin_path( 'assets/js/frontend.js' ) ) ? filemtime( $this->plugin_path( 'assets/js/frontend.js' ) ) : '1.1.9',
			true
		);
